...
* SSS Employee Contribution _(deducted 1st half only)_
* PHIC Employee Contribution _(deducted 2nd half only)_
* HDMF Employee Contribution _(deducted 2nd half only)_
* Loan Deductions
* Withholding Tax _(based on employment status & taxable income)_
...
_(where columns reference payroll register fields)_
...
- Clickable fields:
  ...
  - **Employee Name** → Example: _Doe, John D._ (can be left blank to generate for all personnel)

### Payslip Illustration

![Payslip Example](Resources/docs/images/payslip.png)
